...
library(MASS)
library(pROC)
setwd("D:/Spring 2022/sumeet/project/telco_churn/telco_churn")
getwd()
churncsv <- read.csv("D:/Spring 2022/sumeet/project/telco_churn/telco_churn/customer_churn_data.csv")
summary(churncsv)
nrow(churncsv)
